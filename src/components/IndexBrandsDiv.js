...
function IndexBrand() {
    return (
        <div className="flex items-center group flex-col font-bold">
            <div style={{minHeight:68, minWidth:68}} className="rounded-full md:shadow-none md:border transition-all group-hover:ring-2 ring-red-600 h-[68px] w-[68px] bg-[#f5f5f5] flex items-center justify-center ">
