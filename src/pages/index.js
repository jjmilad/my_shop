  ...
  return (
    <div className="w-full min-h-screen">
      <div className="index-bg h-[320px]">
        <div className='flex container mx-auto md:w-[70%] pt-5 px-6 justify-center items-center'>
            ...
            <div className="bg-primary md:py-[8px] py-[9px] rounded-r-full md:rounded-r-xl px-4">
